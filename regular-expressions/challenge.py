## Question 1 We're working with a CSV file, which contains employee information.
...
## Question 3 The transform_comments function converts comments in a Python script into those usable by a C compiler.
...
## Question 4 The convert_phone_number function checks for a U.S. phone number format: XXX-XXX-XXXX (3 digits followed by a dash, 3 more digits followed by a dash, and 4 digits), and converts it to a more formal format that looks like this: (XXX) XXX-XXXX.
## Fill in the regular expression to complete this function.
## Hint: ask yourself what group() will return.
...
# Should be "123-123-12345"
print(convert_phone_number("Phone number of Buckingham Palace is +44 303 123 7300"))
# Should be "Phone number of Buckingham Palace is +44 303 123 7300"
